    ...
    class Send
    {
        public static void Main()
        {
            ...
            using (var channel = connection.CreateModel())
            {
                ...
                xmlStr = "<message><header><messageType>Event</messageType><description>Creation of an Event</description><sender>front-end</sender><!-- crm --></header><datastructure><UUID>AZErty3</UUID><name>Footballistic</name><timestamp>1522113440</timestamp><version>2</version><isActive>true</isActive><extraField></extraField></datastructure></message>";
